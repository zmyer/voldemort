...
public class StoreDefinition implements Serializable {
    ...
    public String diff(StoreDefinition other, String thisName, String otherName) {
        if (this.equals(other)) {
            ...
            if (this.getReplicationFactor() != other.getReplicationFactor()) {
                addToDiff("Replication factor", this.getReplicationFactor(), other.getReplicationFactor(), sb, thisName,
                        otherName);
            }
            ...
            if (!Objects.equal(this.getPreferredReads(), other.getPreferredReads())) {
                addToDiff("Preferred reads", this.getPreferredReads(), other.getPreferredReads(), sb, thisName,
                        otherName);
            }
            if (this.getRequiredWrites() != other.getRequiredWrites()) {
                addToDiff("Required writes", this.getRequiredWrites(), other.getRequiredWrites(), sb, thisName,
                        otherName);
            }
            if (!Objects.equal(this.getPreferredWrites(), other.getPreferredWrites())) {
                addToDiff("Preferred writes", this.getPreferredWrites(), other.getPreferredWrites(), sb, thisName,
                        otherName);
            }
            ...
            if (!this.getValueSerializer().equals(other.getValueSerializer())) {
                addToDiff("Value serializer", this.getValueSerializer(), other.getValueSerializer(), sb, thisName,
                        otherName);
            }
            if (!Objects.equal(this.getTransformsSerializer() != null ? this.getTransformsSerializer() : null,
                ...
                addToDiff("Transforms Serializer", this.getTransformsSerializer(), other.getTransformsSerializer(), sb,
                        thisName, otherName);
            }
            if (this.getRoutingPolicy() != other.getRoutingPolicy()) {
                addToDiff("Routing policy", this.getRoutingPolicy().toDisplay(), other.getRoutingPolicy().toDisplay(),
                        sb, thisName, otherName);
            }
            ...
            if (!Objects.equal(
                    this.getZoneReplicationFactor() != null ? this.getZoneReplicationFactor().getClass() : null,
                ...
                addToDiff("Zone replication factor", this.getZoneReplicationFactor(), other.getZoneReplicationFactor(),
                        sb, thisName, otherName);
            }
            if (!Objects.equal(this.getZoneCountReads(), other.getZoneCountReads())) {
                addToDiff("Zone count reads", this.getZoneCountReads(), other.getZoneCountReads(), sb, thisName,
                        otherName);
            }
            if (!Objects.equal(this.getZoneCountWrites(), other.getZoneCountWrites())) {
                addToDiff("Zone count writes", this.getZoneCountWrites(), other.getZoneCountWrites(), sb, thisName,
                        otherName);
            }
            ...
            if (!Objects.equal(this.getRetentionScanThrottleRate(), other.getRetentionScanThrottleRate())) {
                addToDiff("Retention scan throttle rate", this.getRetentionScanThrottleRate(),
                        other.getRetentionScanThrottleRate(), sb, thisName, otherName);
            }
            ...
            if (!Objects.equal(this.getHintedHandoffStrategyType(), other.getHintedHandoffStrategyType())) {
                addToDiff("Hinted handoff strategy", this.getHintedHandoffStrategyType().toDisplay(),
                        other.getHintedHandoffStrategyType().toDisplay(), sb, thisName, otherName);
            }
    ...
    private void addToDiff(String propertyName, long thisValue, long otherValue, StringBuilder sb, String thisName,
            String otherName) {
        addToDiff(propertyName, Long.toString(thisValue), Long.toString(otherValue), sb, thisName, otherName);
    }

    private void addToDiff(String propertyName, int thisValue, int otherValue, StringBuilder sb, String thisName,
            String otherName) {
        addToDiff(propertyName, Integer.toString(thisValue), Integer.toString(otherValue), sb, thisName, otherName);
    }

    private void addToDiff(String propertyName, Object thisValue, Object otherValue, StringBuilder sb, String thisName,
            String otherName) {
        addToDiff(propertyName, String.valueOf(thisValue), String.valueOf(otherValue), sb, thisName, otherName);
    }

    private void addToDiff(String propertyName, String thisValue, String otherValue, StringBuilder sb, String thisName,
            String otherName) {
